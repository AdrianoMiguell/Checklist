            ...
            <div class="d-flex align-items-center gap-1">
                ...
                @if (isset($tasks) && $tasks->count() > 0)
                    <form action="{{ route('task.delete_all') }}" method="POST">
                        ...
                        <!-- Button trigger modal -->
                        <button type="button" class="btnG btnG-green rounded-circle p-1" data-bs-toggle="modal"
                            data-bs-target="#deleteAllModal" style="width: 40px; height: 40px;">
                ...
                <div class="modal-body p-0">
                    <form action="{{ Route('task.create') }}"
                        ...
                        <div class="mx-3 w-100">
                            ...
                            <textarea type="text" name="description" id="create_description" class="form-control" maxlength="250"> </textarea>
                            <input type="hidden" name="checklist_id" value="{{ $checklist->id }}">
                        </div>
